...
PLUGINS_TO_INSTALL[grafana-opensearch-datasource]="https://grafana.com/api/plugins/grafana-opensearch-datasource/versions/2.26.1/download?os=linux&arch=${ARCH}"
PLUGINS_TO_INSTALL[grafana-esnet-matrix-panel-viz]="https://grafana.com/api/plugins/esnet-matrix-panel/versions/1.0.10/download"
